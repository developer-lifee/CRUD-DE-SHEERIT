...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlGetUserData = "SELECT correo, contrasena FROM elneflis WHERE streaming = 'Youtube' AND deben IS NULL LIMIT 1";
    ...
    $sql = "UPDATE elneflis SET nombre = ?, apellido = ?, whatsapp = ?, deben = ? WHERE streaming = 'Youtube' AND deben IS NULL LIMIT 1";
